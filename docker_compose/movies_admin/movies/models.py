...
class Person(UUIDMixin, TimeStampedMixin):
    full_name = models.CharField(_("name"), max_length=255, blank=True)
...
class Filmwork(UUIDMixin, TimeStampedMixin):
    ...
    type = models.TextField(_("type"), blank=True, choices=FilmType.choices)
...
class GenreFilmwork(UUIDMixin):
    film_work = models.ForeignKey(
        Filmwork, verbose_name=_("verbose_name_film_work"), on_delete=models.CASCADE
    )
    genre = models.ForeignKey(
        Genre, verbose_name=_("verbose_name_genre"), on_delete=models.CASCADE
    )
    created = models.DateTimeField(auto_now_add=True)
...
class PersonFilmwork(UUIDMixin):
    ...
    person = models.ForeignKey(
        Person, verbose_name=_("verbose_name_person"), on_delete=models.CASCADE
    )
